    ...
    this.ref.child('maps').on('value', function (snapshot)
    {
        ...
        */
        ...
        snapshot.forEach(function (data)
        {
            ...
            innerHTML_array[divider_num] += "\<div name=\"myCards\" class=\"myMapCard w3-container w3-card-0 w3-round-large w3-section w3-border w3-right \"\>\<img id = \"" + data.val().map + randomID + "\"src=\"";
